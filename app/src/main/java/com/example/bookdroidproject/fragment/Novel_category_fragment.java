...
public class Novel_category_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.novel_category_fragment,container,false);
...
//                          model1.setImg_book(R.drawable.novel_book);
                            ...
                            Log.e("Title Book :: "+i,jsonObject.getString("book_image"));
