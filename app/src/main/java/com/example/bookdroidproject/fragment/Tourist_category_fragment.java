...
public class Tourist_category_fragment extends Fragment {
    ...
    public String urlNovel ;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tourist_category_fragment,container,false);
    ...
    private void postData() {
        urlNovel = getResources().getString(R.string.url)+"/api/book/all";

        try {
            RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
            JSONObject jsonBody = new JSONObject();
            jsonBody.put("cat_id",5);
