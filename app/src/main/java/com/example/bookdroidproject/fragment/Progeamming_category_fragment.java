...
public class Progeamming_category_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.programming_category_fragment,container,false);


        booksmodelList = new ArrayList<>();
        booksmodelList1 = new ArrayList<>();
